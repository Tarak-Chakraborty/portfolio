...
function Links() {
  return (
    <div className=' text-left w-fit'>
        <div className= 'mb-5'>
            <a href="https://twitter.com/tarakchakr67052" className='text-gray-600 text-sm tracking-tight flex gap-4'>
            <svg
        ...
        <div className= 'mb-5'>
            <a href="https://github.com/Tarak-Chakraborty" className='text-gray-600 text-sm tracking-tight flex gap-3'>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
        ...
        <div className= 'mb-5'>
            <a href="https://www.linkedin.com/in/tarak-chakraborty-792075287/" className='text-gray-600 text-sm tracking-tight flex gap-4'>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                width="15"
        ...
        <div className= 'mb-5'>
            <a href="https://www.instagram.com/tarakchakraborty61/" className='text-gray-600 text-sm tracking-tight flex gap-4'>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                width="15"
        ...
        <div className='mt-2'>
            <a href="mailto:chakrabortytarak83@gmail.com" className='text-gray-600 text-sm tracking-tight flex gap-3'>
            <svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 640 512"
  width="18"
